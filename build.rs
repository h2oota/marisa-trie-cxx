...
"#,
	...
	.clang_args(libmarisa_config
        ...
        .allowlist_type("marisa_num_tries|marisa_cache_level|marisa_tail_mode|marisa_node_order|marisa_config_mask|exception_record|marisa::(?:Key|Query|Ketset|Agent|Trie)")
	.opaque_type("marisa::(?:Key|Query|Keyset|Agent|Trie)")
        .disable_functions(disable_in_release)
        .blocklist_type("marisa::Key_Union")
