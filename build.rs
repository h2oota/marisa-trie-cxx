...
"#,
	...
	.clang_args(libmarisa_config
        ...
        .allowlist_type("marisa_num_tries|marisa_cache_level|marisa_tail_mode|marisa_node_order|marisa_config_mask|exception_record|marisa::Test")
	.opaque_type("marisa::(?:Key|Query|Keyset|Agent|Trie|Test)")
