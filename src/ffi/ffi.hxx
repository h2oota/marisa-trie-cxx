...
//     typedef marisa::NodeOrder marisa_NodeOrder;
     ...
     unsigned char key_index(const marisa::Key*, std::size_t, const struct exception_record **); // operator[]
     ...
     void key_set_str(marisa::Key*, const char *, std::size_t, const struct exception_record **);
     void key_set_id(marisa::Key*, std::size_t, const struct exception_record **);
     void key_set_weight(marisa::Key*, float, const struct exception_record **);
     ...
     marisa::Key* set(marisa::Keyset*, std::size_t, const struct exception_record **);
